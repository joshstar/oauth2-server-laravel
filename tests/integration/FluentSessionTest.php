...
class FluentSessionTest extends AbstractDBTestCase
{
    ...
    public function test_session_is_created()
    {
        ...
        $this->assertInstanceOf('joshstar\OAuth2\Server\Entity\SessionEntity', $session);
    ...
    {
        $authCode = m::mock('joshstar\OAuth2\Server\Entity\AuthCodeEntity');
    ...
    {
        $accessToken = m::mock('joshstar\OAuth2\Server\Entity\AccessTokenEntity');
